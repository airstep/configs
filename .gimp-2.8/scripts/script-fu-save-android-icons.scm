; --------------------------------------------------------------------------
; Save Android Icons
; https://github.com/ruleant/script-fu-save-android-icons
...
(cond (
	(or (= iconType 4) (or (= iconType 5) (= iconType 6) (= iconType 8)) )
	(aset formatsW 0 24)
	(aset formatsW 1 32)
	(aset formatsW 2 48)
	(aset formatsW 3 64)
...
( cond ((= iconType 8 ) (set! namePrefix "ic_action_")) )
...
(script-fu-register	"script-fu-save-android-icons"
					...
					"22 September 2011"
					"RGB* GRAY* INDEXED*"
					SF-OPTION	"Android icons type"		'("Launcher Icons (36x36 48x48 72x72 96x96i 144x144 192x192)" "Menu Icons  (36x36 48x48 72x72 96x96 144x144 192x192)" "Action Bar Icons (18x18 24x24 36x36 48x48 72x72 96x96)" "Status Bar Icons (18x18 24x24 36x36 48x48 72x72 96x96)" "Tab Icons (24x24 32x32 48x48 64x64 96x96 128x128)" "Dialog Icons (24x24 32x32 48x48 64x64 96x96 128x128)" "List View Icons (24x24 32x32 48x48 64x64 96x96 128x128)" "Custom Icon  mdpi=baseline ldpi=0.75x hdpi=1.5x xhdpi=2x xxhdpi=3x xxxhdpi=4x" "Action Icons (24x24 32x32 48x48 64x64 96x96 128x128)")
